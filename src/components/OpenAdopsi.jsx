  ...
  return (
    <div className=" px-[150px] py-3">
      <div>
        ...
        <form
          action="#"
          className=" grid grid-cols-[repeat(auto-fit,minmax(500px,1fr))] gap-[30px] font-Poppins  "
        >
        ...
        >
          <a
            href=""
            className="mx-auto font-Poppins px-2 py-1 bg-[] text-3xl font-semibold font-heading-8-semibold text-gray text-left inline-block min-w-[65px] z-[1] mq450:text-[19px]"
          >
            kirim
          </a>
        </div>
